...
st.markdown('<div style="text-align:center;padding:2rem 0 1rem;color:var(--muted);font-size:0.8rem">Built with ⚡ Gemini AI · Google Cloud · Streamlit &nbsp;|&nbsp; Vibe2Ship Hackathon 2026</div>', unsafe_allow_html=True)import streamlit as st
import requests
import json
from datetime import datetime, date
import os
